...
Layer files are **universal across all three jurisdictions** — implementation patterns are shared. Jurisdiction-specific obligations live in `skills/personal-data-protection/jurisdictions/<code>/obligations/`.
