...
- **Non-SEA jurisdictions.** This repo is scoped to SEA personal-data-protection statutes: SG PDPA, TH PDPA, ID UU PDP, MY PDPA, and PH DPA today, with VN PDPD planned for v0.5. GDPR, UK GDPR, CCPA, etc. are intentionally excluded — they are significantly different statutes and would dilute the skill. A separate project per jurisdiction family is a better pattern.
